...
public class MonitoriaController {
    ...
    @ApiOperation("Listar todas as monitorias")
    @ApiResponses({
    ...
    @ApiOperation("Listar uma monitoria por id")
    @ApiResponses({
        @ApiResponse(code = 200, message = "Requisição realizada com sucesso"),
        @ApiResponse(code = 404, message = "Falha na requisição")
    })
    ...
    @ApiOperation("Cadastrar uma monitoria")
    @ApiResponses({
        @ApiResponse(code = 200, message = "Requisição realizada com sucesso"),
        @ApiResponse(code = 404, message = "Falha na requisição")
    })
    ...
    @PutMapping("monitoria")
     @ApiOperation("Atualizar uma monitoria")
    @ApiResponses({
        @ApiResponse(code = 200, message = "Requisição realizada com sucesso"),
        @ApiResponse(code = 404, message = "Falha na requisição")
    })
    ...
    @ApiOperation("Remover uma monitoria")
    @ApiResponses({
        @ApiResponse(code = 200, message = "Requisição realizada com sucesso"),
        @ApiResponse(code = 404, message = "Falha na requisição")
    })
